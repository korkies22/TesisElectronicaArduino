...
void setup()
{
  ...
  PCintPort::attachInterrupt(pinEncoderDerF, countEncoderDer, RISING);
  PCintPort::attachInterrupt(pinEncoderIzqF, countEncoderIzq,RISING); // attach a PinChange Interrupt to our pin on the rising edge
